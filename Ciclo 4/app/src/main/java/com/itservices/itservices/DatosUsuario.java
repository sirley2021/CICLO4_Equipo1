...
public class DatosUsuario extends AppCompatActivity {
    private EditText EIdentificacion,ENombres,EApellidos,
            Eemail,ENumero,EAddress,EPass;
    private TextView PlanesUsuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlanesUsuario = (TextView) findViewById(R.id.PlanesUsuario);
    ...
    private void importardatos() {
        ...
        String Identificacion = Dato.getString("Identificacion");

        GestionBasedatos AdminBD = new GestionBasedatos
                (this, "Administracion",null,1);
        SQLiteDatabase Basededatos = AdminBD.getWritableDatabase();
        EIdentificacion.setText(Identificacion);



        if (!Identificacion.isEmpty()){
            Cursor fila = Basededatos.rawQuery
                    ("Select * From Usuarios where Identifacion="+Identificacion,null);
            if(fila.moveToFirst()){
                ...
                PlanesUsuario.setText(fila.getString(7));
            }
            else{
